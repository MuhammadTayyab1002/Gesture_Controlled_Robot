...
#        print(landmarks)
       ...
       # mp_drawing.draw_landmarks(image, results_1.handLandmarks, mp_Hand.HAND_CONNECTIONS)
        ...
        if cv2.waitKey(10) & 0xFF == ord('q'):
            break
        #Calculating Angle
        wrist=[landmarks_1[mp_holistic.HandLandmark.WRIST.value].x,landmarks_1[mp_holistic.HandLandmark.WRIST.value].y]
        Thumb_MCP=[landmarks_1[mp_holistic.HandLandmark.THUMB_MCP.value].x,landmarks_1[mp_holistic.HandLandmark.THUMB_MCP.value].y]
        Thumb_IP=[landmarks_1[mp_holistic.HandLandmark.THUMB_IP.value].x,landmarks_1[mp_holistic.HandLandmark.THUMB_IP.value].y]
        INDEX_FINGER_MCP=[landmarks_1[mp_holistic.HandLandmark.INDEX_FINGER_MCP.value].x,landmarks_1[mp_holistic.HandLandmark.INDEX_FINGER_MCP.value].y]
        INDEX_FINGER_PIP=[landmarks_1[mp_holistic.HandLandmark.INDEX_FINGER_PIP.value].x,landmarks_1[mp_holistic.HandLandmark.INDEX_FINGER_PIP.value].y]
        MIDDLE_FINGER_MCP=[landmarks_1[mp_holistic.HandLandmark.MIDDLE_FINGER_MCP.value].x,landmarks_1[mp_holistic.HandLandmark.MIDDLE_FINGER_MCP.value].y]
        MIDDLE_FINGER_PIP=[landmarks_1[mp_holistic.HandLandmark.MIDDLE_FINGER_PIP.value].x,landmarks_1[mp_holistic.HandLandmark.MIDDLE_FINGER_PIP.value].y]
        RING_FINGER_MCP=[landmarks_1[mp_holistic.HandLandmark.RING_FINGER_MCP.value].x,landmarks_1[mp_holistic.HandLandmark.RING_FINGER_MCP.value].y]
        RING_FINGER_PIP=[landmarks_1[mp_holistic.HandLandmark.RING_FINGER_PIP.value].x,landmarks_1[mp_holistic.HandLandmark.RING_FINGER_PIP.value].y]
        PINKY_MCP=[landmarks_1[mp_holistic.HandLandmark.PINKY_MCP.value].x,landmarks_1[mp_holistic.HandLandmark.PINKY_MCP.value].y]
        PINKY_PIP=[landmarks_1[mp_holistic.HandLandmark.PINKY_PIP.value].x,landmarks_1[mp_holistic.HandLandmark.PINKY_PIP.value].y]
